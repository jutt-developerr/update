    ...
    */
    ...
    public function transform(Driver $user)
    {
        $params = [
            ...
            'car_make'=>$user->car_make ?? $user->custom_make,
            'car_model'=>$user->car_model  ?? $user->custom_model,
            'car_make_name'=>$user->car_make_name  ?? $user->custom_make,
            'car_model_name'=>$user->car_model_name  ?? $user->custom_model,
        ...
        if($user->fleet_id){
            $params['car_make_name'] = $user->fleetDetail->carBrand->name ?? $user->fleetDetail->custom_make;
            $params['car_model_name'] = $user->fleetDetail->carModel->name ?? $user->fleetDetail->custom_model;
