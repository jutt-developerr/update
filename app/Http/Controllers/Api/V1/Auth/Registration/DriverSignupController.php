    ...
    */
    ...
    public function register(DriverRegistrationRequest $request)
    {
        $mobileUuid = $request->input('uuid');
            ...
            $created_params = $request->only(['service_location_id', 'name','mobile','email','address','state','city','country','gender','car_make','car_model','car_color','car_number','vehicle_year','vehicle_type','custom_make','custom_model']);
...
// request has multi vehicles
    ...
    */
    ...
    public function ownerRegister(Request $request){
        ...
        $this->database->getReference('owners/'.$owner->id)->set(['id'=>$owner->id,'active'=>1,'approve'=>1,'updated_at'=> Database::SERVER_TIMESTAMP]);
